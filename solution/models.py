...
class User(AbstractUser):
    ...
    referal_user = models.ForeignKey('self', on_delete = models.DO_NOTHING, null = True, blank = True)
    ...
    def get_invited_users(self):
        numbers = User.objects.filter(referal_user_id=self.id).values_list('phone_number', flat = True)
